...
class _ClienteCatalogoScreenState extends State<ClienteCatalogoScreen> {
  ...
  Future<void> comprarProducto(Producto p) async {
    try {
      await http.post(
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text("${p.nombre} comprado")),
      );
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Error al realizar compra")),
      );
    }
  }
                ...
                builder: (context, snapshot) {
                  ...
                  return GridView.builder(
                    ...
                    gridDelegate:
                      ...
                      crossAxisSpacing: 12,
                      mainAxisSpacing: 12,
                      childAspectRatio: 0.75, // 👈 IMPORTANTE (evita overflow)
                    ),
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed:
                                      sinStock ? null : () => comprarProducto(p),
